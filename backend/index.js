    ...
    try {
        ...
        if (title === undefined && completed === undefined) {
            return res.status(400).json({
                ...
                message: 'Debes proporcionar al menos un campo para actualizar (title o completed)'
            });
        }
        ...
        console.log(`✅ Tarea actualizada: ID ${taskId}, Completada: ${updatedTask.completed}`);
...
router.patch('/tasks/:id/uncomplete', (req, res) => {
    try {
        const taskId = parseInt(req.params.id);
